...
const planData: PlanData[] = [
  { name: 'Free', price: '$0 /user/month', description: 'For individuals:', features: ['Access to vO.dev/chat'] },
  { name: 'Premium', price: '$20 /user/month', description: 'For individuals:', features: ['Access to vO.dev/chat'] },
  { name: 'Team', price: '$30 /user/month', description: 'For teams:', features: ['Access to vO.dev/chat'] },
  { name: 'Enterprise', price: '$50 /user/month', description: 'For enterprises:', features: ['Access to vO.dev/chat', 'Dedicated support'] }
];
      ...
      {selectedPlan && (
        <div className="w-full justify-start text-start mt-5 bg-gray-50 p-6 border border-gray-200 rounded-md">
          ...
          {selectedPlan.features.map((feature, index) => (
            <p key={index} className="mt-2">{feature}</p>
          ))}
        </div>
      )}

      <footer className="w-full mt-10">
        <p className="text-xs flex gap-1 justify-center">Compare plans and options on our <span className='text-blue-400 flex'>  pricing page   <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/f8aea8d36044f1a72302f013fc14536bf3a98b8d70d455a13666c35a7c80afbd?apiKey=2a27755d9b58497580a442835654a8d8&" alt="" /></span></p>
        <ActionButtons toggleUpgradePlan={toggleUpgradePlan}/>
      </footer>
    </section>
  );
};
